...
The various action elements are used to perform actions such as move, create, delete, or copy directories or files. These actions are also used to gather data using SQL commands to be compared in the assertion steps.
